...
abstract class AppLocalizations {
  ...
  /// No description provided for @todoListAdd.
  ///
  /// In en, this message translates to:
  /// **'Add'**
  String get todoListAdd;

  /// No description provided for @todoListNewTitle.
  ///
  /// In en, this message translates to:
  /// **'New todo'**
  String get todoListNewTitle;

  /// No description provided for @todoListNewDescription.
  ///
  /// In en, this message translates to:
  /// **'What needs to be done?'**
  String get todoListNewDescription;

  /// No description provided for @todoListCreate.
  ///
  /// In en, this message translates to:
  /// **'Create'**
  String get todoListCreate;

  /// No description provided for @todoListCancel.
  ///
  /// In en, this message translates to:
  /// **'Cancel'**
  String get todoListCancel;

  /// No description provided for @todoListDelete.
  ///
  /// In en, this message translates to:
  /// **'Delete'**
  String get todoListDelete;

  /// No description provided for @todoListDeleteConfirm.
  ///
  /// In en, this message translates to:
  /// **'Delete this todo?'**
  ...
  /// No description provided for @connectivityRetry.
  ///
  /// In en, this message translates to:
  /// **'Retry'**
  String get connectivityRetry;
